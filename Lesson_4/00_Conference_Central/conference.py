...
# - - - Conference objects - - - - - - - - - - - - - - - - -
    ...
    def filterPlayground(self, request):
        ...
        #city_filter = ndb.query.FilterNode("city", "=", "London")
        #topic_filter = ndb.query.FilterNode("topics", "=", "Medical Innovations")
        #q = q.filter(city_filter, topic_filter)
        q = q.filter(Conference.name == "London")
